export default {
  async fetch(request, env, ctx) {
    ...
    // Определение запрашиваемой версии:
    // ?v=persona или путь /persona -> Ultra Persona v4.0
    // иначе -> Classic v3.2
    const isPersona = url.searchParams.get("v") === "persona" || url.pathname.includes("persona");
    const script = isPersona ? `<#
=================================================================
