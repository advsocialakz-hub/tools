...
// Supports: All version branches (v4, v5, v6, v7, v7.5, audit, auto, diag)
...
export default {
  async fetch(request, env, ctx) {
    ...
    if (branch) {
      const targetFile = file || (branch.includes("audit") ? "audit.ps1" : (branch.includes("auto") ? "autoloop.ps1" : (branch.includes("diag") ? "diagnose.ps1" : "persona.ps1")));
    ...
    if (v === "diag" || v === "diagnose" || v === "sys" || v === "forensic" || v === "audit-net") {
      script = SCRIPTS["diag"];
