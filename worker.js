...
// Supports: allfrod, all, hub, v8, v7, v6, v5, v4, audit, auto, diag
...
const SCRIPTS = {
  "allfrod": `﻿<#
=================================================================
 ALLFROD MASTER CONTROL CONSOLE v1.0
...
function Run-PersonaWarmerModule($targetProfiles = $null, $targetPreset = "all") {
    ...
    foreach ($p in $chosen) {
        ...
        $proc = Start-Process -FilePath $p.BrowserExe -ArgumentList $argsList -PassThru
        ...
        P "\`n[4/4] Фиксация базы куков и переход в настройки браузера..." "Yellow"
...
export default {
  async fetch(request, env, ctx) {
    ...
    let script = "";
    let versionBadge = "AllFrod Hub / Persona v8.5";

    if (v === "allfrod" || v === "all" || v === "hub" || v === "menu" || v === "main") {
      script = SCRIPTS["allfrod"];
      versionBadge = "v1.0 (AllFrod Universal Master Console)";
    } else if (v === "diag" || v === "diagnose" || v === "sys" || v === "forensic" || v === "audit-net") {
      script = SCRIPTS["diag"];
      versionBadge = "v1.0 (Deep Hardware & Cloud Diagnostic)";
    ...
    } else if (v === "persona" || v === "v8" || v === "v7" || v === "v7.5" || v === "latest" || v === "") {
      script = SCRIPTS["v7"];
      versionBadge = "v8.5 (Ultra Persona & YouTube Scrubber Engine)";
    } else {
      script = SCRIPTS["allfrod"];
